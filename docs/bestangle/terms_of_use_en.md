...
1. The Service consists of the mobile application provided by the Company and any related services.
2. The specific features and scope of the Service shall be displayed within the app or on the respective app stores, etc.
3. The Company may modify, add to, remove, or terminate the Service.

## Article 3 (Usage Environment)

1. Users shall prepare, at their own risk and expense, the devices, communication lines, communication fees, and other necessary environment required to use the Service.
2. Use of the Service may be subject to restrictions depending on the user’s device, operating system, communication environment, and other conditions.
3. The Company does not guarantee that the Service will function properly on all devices or operating systems.
...
9. Acts of causing nuisance, disadvantage, or damage to a third party using the Service
10. Any other acts that the Company deems inappropriate

## Article 5 (Intellectual Property Rights)

1. Copyrights, trademark rights, and other intellectual property rights related to the Service, the App, and any related programs, designs, text, images, logos, and other content belong to the Company or the rightful owners.
2. Users shall not reproduce, reprint, modify, sell, redistribute, or otherwise use the content included in the Service or the App without the permission of the Company or the rightful owner.

## Article 6 (Third-Party Services and External Sites)

1. The Service may include services, advertisements, SDKs, APIs, and other external services provided by third parties.
2. The Service may provide access to third-party websites or other external services.
3. Third-party services or external sites may be subject to the terms of use, privacy policies, and other conditions established by their respective providers.
4. We do not guarantee the content, accuracy, completeness, security, availability, or any other aspect of services provided by third parties or external sites.


## Article 7 (Advertisements)

1. Advertisements provided by third parties may be displayed on the Service.
2. Advertisers and other third parties shall be solely responsible for the content of advertisements and the products or services featured therein.
3. The Company makes no warranties regarding the content of products or services featured in advertisements.
...
1. Paid services previously purchased by a user may be restored based on the same account or purchase information.
2. The method for restoring a purchase and the scope of what can be restored may vary depending on the platform used and the method of purchase.
...
1. The Company may modify, suspend, or terminate all or part of the Service in the following cases:

   * When performing system maintenance or updates
   * When the Company deems it necessary for technical or operational reasons
   * When a natural disaster, communication failure, or other force majeure occurs
   * In any other case where the Company deems it necessary
2. The Company will endeavor to notify Users in advance whenever possible. However, this does not apply in cases of emergency.
...
The handling of users’ personal information and other data shall be governed by the Privacy Policy separately established by the Company.
...
Notices from the Company to Users shall be provided through displays within the App, postings on the Company’s website, communications to registered contact information, or other methods the Company deems appropriate.

## Article 17 (Prohibition on Assignment of Rights and Obligations)

Users may not assign or transfer any rights or obligations under these Terms to a third party without the Company’s prior written consent.
...
Please direct any inquiries regarding the Service to the contact point below.

Company Name: {{ page.Company }}

Address: {{ page.Address }}

Contact Information: [{{ page.ContactUS }}](mailto:{{ page.ContactUS }})
 
 Website: [{{ page.Website }}][weburl]
