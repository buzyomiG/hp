...
aside: false
permalink: privacy_policy_bestangle_jp/
---

**プライバシーポリシー**

プライバシーポリシーは、ベストアングル （以下「サービスプロバイダー」といいます）が無料サービスとして提供するモバイル端末向けアプリ（以下「本アプリケーション」といいます）に適用されます。本サービスは「現状のまま」ご利用いただくことを意図しています。


**顔写真および顔関連データ**

ベストアングルは、デバイスのカメラを使用して、ユーザーの顔が含まれる可能性のある写真をプレビューおよび撮影します。

このアプリは、ユーザーのデバイス上でGoogle ML Kit Face Detectionをローカルに使用し、検出された顔の向きに関する情報を処理することで、ユーザーが写真撮影時に好みの顔の角度を判断、比較、記録するのを支援するなど、アプリのコア機能を提供します。

アプリは、ユーザーのデバイスに以下の情報をローカルに保存する場合があります。

- ユーザーの顔が写っている可能性のある写真。
- X、Y、Z軸の面角度値。
- 写真が撮影された日時。

ベストアングルは、人物の身元確認や検証に顔データを使用せず、顔認識も行いません。

顔写真、顔の角度値、および写真が撮影された日時情報は、ユーザーのデバイス上でローカルに処理および保存されます。当社は、これらの情報をサーバーにアップロード、送信、同期、またはその他の方法で送信することはありません。

当社は、顔写真、顔の角度値、その他の顔関連データを、広告主、広告プラットフォーム、分析プロバイダー、データブローカー、情報再販業者、その他の第三者に販売、貸与、またはその他の方法で提供することはありません。

このアプリは、広告、マーケティング、認証、本人確認、ユーザープロファイリング、データマイニングのために、顔写真や顔の角度データを使用することはありません。

顔写真、顔の角度の値、および写真が撮影された日時情報は、ユーザーが削除するまでユーザーのデバイスに保存されます。

ユーザーはアプリを通じて関連データを削除でき、また、該当する場合は、デバイスの写真管理機能を通じて、デバイスのフォトライブラリに保存されている写真を削除できます。

開発者は、顔写真、顔の角度の値、または関連する写真情報をサーバー上に保存しません。

ユーザーは、デバイスの共有機能を使用して写真を共有することができます。写真は、ユーザーが共有先を明示的に選択し、共有操作を開始した場合にのみ共有されます。

デバイスの共有機能を通じて共有されるのは、ユーザーが選択した写真ファイルのみです。X、Y、Z軸の顔の角度値、および写真が撮影された日時情報は共有プロセスに含まれず、共有されません。

このアプリは、顔写真や顔に関するデータを第三者と自動的に共有することはありません。

ユーザーが写真を第三者のアプリまたはサービスと共有した後、共有された写真の取り扱いは、選択された第三者のプライバシーポリシーおよび慣行に従うものとします。
